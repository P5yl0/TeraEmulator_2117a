...
namespace Network
{
    public class OpCodes
    {
        ...
        public static int Version = 2117;
        ...
        public static void Init()
        {
            ...
            #region Client packets 2117
            // Auth
            Recv.Add(unchecked((short) 0x4DBC), typeof (CpRequestVersion)); //all revs Check Verrsion
            Recv.Add(unchecked((short) 0xA863), typeof (CpRequestAuth)); //2117 EU Check Account Login/Auth Process
            Recv.Add(unchecked((short) 0x7941), typeof (CpRequestSystemInfo)); //2117 EU 
            Recv.Add(unchecked((short) 0x7C11), typeof (CpSystemInfo)); //2117 EU


            //Characters
            Recv.Add(unchecked((short) 0x8347), typeof (CpRequestCharacterList)); //2117 EU

            //Enter World
            Recv.Add(unchecked((short) 0x9069), typeof (CpPlay)); //2117 EU
            Recv.Add(unchecked((short) 0x9D8A), typeof (RpGetBindPoint)); //2117 EU dont know if its the right one...

            Recv.Add(unchecked((short) 0x6EC7), typeof (CpRequestVersion)); //ToDo added only CpRequestVersion(empty) for ingame test
            Recv.Add(unchecked((short) 0x53FD), typeof (CpRequestVersion)); //ToDo added only CpRequestVersion(empty) for ingame test
            Recv.Add(unchecked((short) 0x4EB5), typeof (RpEnterWorld)); //2117 EU

            //User interface
            //Recv.Add(unchecked((short) 0x7D1B), typeof(RpUISettings)); //ToDo ingame options save button i think opcode maybe not right

            Recv.Add(unchecked((short) 0xB770), typeof (CpRequestCharacterCreate)); //2117 EU
            Recv.Add(unchecked((short) 0x6FC0), typeof (CpCheckName)); //2117 EU
            Recv.Add(unchecked((short) 0xD62C), typeof (CpCheckNameForUse)); //2117 EU
            Recv.Add(unchecked((short) 0x84A9), typeof (CpCreateCharacter)); //2117 EU
            Recv.Add(unchecked((short) 0x7C22), typeof (CpDeleteCharacter)); //2117 EU ToDo delet from SQL database
            ...
            #endregion Client packets 2117


            #region Server packets 2117
            // Auth
            Send.Add(typeof (SpSendVersion), unchecked((short) 0x4DBD)); //all revs


            //Character
            Send.Add(typeof (SpSendCharacterList), unchecked((short) 0x94E8)); //2117 EU
            Send.Add(typeof (SpCharacterCheckNameResult), unchecked((short) 0xC81D)); //2117 EU
            Send.Add(typeof (SpCharacterCreateResult), unchecked((short) 0xB28B)); //2117 EU
            Send.Add(typeof (SpCharacterDelete), unchecked((short) 0x65BD)); //2117 EU

            //UI Settings
            Send.Add(typeof (SpUISettings), unchecked((short) 0x7CD4));  //2117 EU

            //ToDo:
            Send.Add(typeof (SpCharacterInit), unchecked((short) 0x5527)); //2117 EU


            //stopped here
            //Character
            Send.Add(typeof (SpCharacterCraftStats), unchecked((short)0xF7E2)); //1725 EU
