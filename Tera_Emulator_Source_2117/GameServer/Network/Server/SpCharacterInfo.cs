...
namespace Network.Server
{
    public class SpCharacterInfo : ASendPacket
    {
        ...
        public override void Write(BinaryWriter writer)
        {
            ...
            //revision 2113 Add
            WriteH(writer, (short)Player.PlayerData.Details1.Length); //2000
            WriteH(writer, (short)Player.PlayerData.Details2.Length); 
            ...
            WriteH(writer, 0); //Details shift
            WriteH(writer, (short) Player.PlayerData.Details1.Length); //2000
            WriteH(writer, (short)Player.PlayerData.Details2.Length); //2113 Add
            WriteH(writer, 0); //Unk2 shift
            WriteH(writer, 0); //Unk3 shift
