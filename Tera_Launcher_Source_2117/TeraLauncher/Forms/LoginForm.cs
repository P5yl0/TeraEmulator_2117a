...
namespace TeraLauncher
{
    public partial class LoginForm : Form
    {
            ...
            if (master_account_name != "" && master_account_password != "")
                {
                    ...
                    //network
                    //string webStringResponse = getWebStringResponse("http://psylo.dyndns.org/auth.php", "POST", "username=" + master_account_name + "&password=" + master_account_password);
        ...
        private void _notloggedPanel_Paint(object sender, PaintEventArgs e)
        {

        }

        private void _loggedPanel_Paint(object sender, PaintEventArgs e)
        {

        }

        private void _usernameInputBox_TextChanged(object sender, EventArgs e)
        {
